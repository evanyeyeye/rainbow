...
function FilePicker(props) {
  ...
  function handleFileAction(data) {
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].MouseClickFile.id || data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].KeyboardClickFile) {
      console.log("click"); // if the component is in single selection mode,
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].OpenFiles.id) {
      ...
      if (fileToOpen && chonky__WEBPACK_IMPORTED_MODULE_0__["FileHelper"].isDirectory(fileToOpen)) {
        ...
        console.log("setting root to", fileToOpen.id);
...
//# sourceMappingURL=be8b6cb-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJiZThiNmNiLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==