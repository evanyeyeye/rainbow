...
function FilePicker(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(''),
      ...
      idToRefresh = _useState2[0],
      setIdToRefresh = _useState2[1];

  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    // only refresh if there is a valid id
    if (idToRefresh) {
      console.log("requested to refresh", data.payload.file.id);
      setProps({
        "id_to_refresh": idToRefresh
      });
    }
  }, [idToRefresh]); // currentFolderId is the current root (rather than the actual
  // root of the whole tree)

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(file_map.rootFolderId),
      _useState4 = _slicedToArray(_useState3, 2),
      currentFolderId = _useState4[0],
      setCurrentFolderId = _useState4[1];

  function changeDirectory(id) {
    console.log("setting root folder id to", id);
    setProps({
      "root_folder_id": id
    });
  ...
  function handleFileAction(data) {
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].MouseClickFile.id) {
      ...
      if (currentId != "none") {
        ...
        if (chonky__WEBPACK_IMPORTED_MODULE_0__["FileHelper"].isDirectory(currentId)) {
          console.log("requested to update", id);
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].OpenFiles.id) {
      ...
      if (fileToOpen && chonky__WEBPACK_IMPORTED_MODULE_0__["FileHelper"].isDirectory(fileToOpen)) {
        console.log("> open file", targetFile);
        changeDirectory(fileToOpen);
      }
    }
...
//# sourceMappingURL=a10f16e-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhMTBmMTZlLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==