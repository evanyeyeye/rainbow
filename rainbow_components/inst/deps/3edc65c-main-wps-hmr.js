...
var _excluded = ["id", "multiple_selection_allowed", "setProps"];
...
function FilePicker(props) {
  var id = props.id,
      multiple_selection_allowed = props.multiple_selection_allowed,
  ...
  var useFileActionHandler = function useFileActionHandler(setCurrentFolderId) {
    return Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function (data) {
      ...
      } else if (multiple_selection_allowed && data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].ChangeSelection.id) {
        // get selected files
        var _selectedFiles = data.payload.selection;
        _selectedFiles = Array.from(_selectedFiles);
        setProps({
          "selectedFiles": _selectedFiles
        });
        console.log("selected:", _selectedFiles);
        return;
      } else if (!multiple_selection_allowed && (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].MouseClickFile.id || data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].KeyboardClickFile)) {
...
FilePicker.propTypes = {
   ...
   */
  rootFolderId: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.string,
...
//# sourceMappingURL=3edc65c-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIzZWRjNjVjLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==