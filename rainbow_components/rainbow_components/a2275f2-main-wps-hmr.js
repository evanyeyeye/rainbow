...
function FilePicker(props) {
  ...
  function handleFileAction(data) {
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].MouseClickFile.id) {
      ...
      var isDirectory = fileMap[currentId]["isDir"] === true;
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].OpenFiles.id) {
      ...
      var _isDirectory = fileMap[_currentId]["isDir"] === true;

      if (fileToOpen && _isDirectory) {
...
//# sourceMappingURL=a2275f2-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhMjI3NWYyLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==