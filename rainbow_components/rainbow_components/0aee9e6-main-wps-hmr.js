...
var _excluded = ["id", "multiple_selection_allowed", "id_to_refresh"];
...
function FilePicker(props) {
  var id = props.id,
      ...
      otherProps = _objectWithoutProperties(props, _excluded); // setProps will not be defined unless this is running in Dash,
  ...
  var fileMap = props.file_map.fileMap || {};
  ...
  function handleFileAction(data) {
    ...
    if (data.id === chonky__WEBPACK_IMPORTED_MODULE_0__["ChonkyActions"].MouseClickFile) {
      console.log(data.payload.clickType, "click"); // if the component is in single selection mode,
...
//# sourceMappingURL=0aee9e6-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIwYWVlOWU2LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==